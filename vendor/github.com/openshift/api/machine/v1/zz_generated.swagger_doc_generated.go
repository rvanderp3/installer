...
var map_FailureDomains = map[string]string{
	...
	"vsphere":   "VSphereFailureDomain configures failure domain information for the VSphere platform.",
...
var map_VSphereFailureDomain = map[string]string{
	...
	"name": "Name is the name of the failure domain in which the vSphere machine provider will create the VM. Failure domains are defined in a cluster's config.openshift.io/Infrastructure resource.",
}
